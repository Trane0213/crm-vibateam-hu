...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/__l5e/assets-v1/863a5395-4f7a-4a0b-8589-d464949800a5/viba-team-logo.png" },
      { name: "twitter:image", content: "/__l5e/assets-v1/863a5395-4f7a-4a0b-8589-d464949800a5/viba-team-logo.png" },
      { name: "theme-color", content: "#ffffff" },
      { name: "apple-mobile-web-app-title", content: "VIBA CRM" },
      { name: "application-name", content: "VIBA CRM" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/863a5395-4f7a-4a0b-8589-d464949800a5/viba-team-logo.png" },
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/863a5395-4f7a-4a0b-8589-d464949800a5/viba-team-logo.png" },
    ],
  }),
