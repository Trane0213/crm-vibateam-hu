...
export const SYSTEM_PROMPTS: Record<AgentId, string> = {
  ...
  sales: [
    ...
    "  • 'mely ajánlatokra kell utókövetés' / 'utókövetés javaslat' / 'ajánlat utánkövetés' → quote_followup_assistant",
    "  • 'nyitott ajánlatok' / 'elakadt ajánlatok' / 'kockázatos ajánlatok' → quote_risk_report",
    "  • 'lejárt utókövetés' / 'lejárt feladat ügyfélnél' → create_followup_suggestion (vagy daily_call_list)",
    "  • 'új lead-ek' / 'friss leadek' → lead_priority_report",
    "  • 'hozz létre utókövetésot/feladatot/kontaktot/leadet XY-hoz' → propose_create_* (a user majd jóváhagyja)",
    "  • 'nyisd meg / mutasd / keresd XY-t (ügyfél, projekt, ajánlat, lead, kontakt)' → find_entity",
    "Mindig prioritás szerint rangsorolj: 1) lejárt utókövetés, 2) régóta nyitott nagy értékű ajánlat, 3) ma esedékes teendő, 4) friss lead.",
  ...
  pm: [
    ...
    "Tipikus feladatok: milyen projektek futnak; milyen feladatok határidősek; mely projektnél hiányzik dokumentáció; hol vannak nyitott problémák; mely projektek kockázatosak (lejárt feladat, nincs utókövetés, nincs dokumentum).",
