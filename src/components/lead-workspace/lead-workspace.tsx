 ...
 */
export function LeadWorkspace({ mode }: { mode: "marketing" | "sales" }) {
  const [selectedId, setSelectedId] = useState<string | null>(null);
  return (
    <div className="mx-6 mb-6 grid h-[640px] grid-cols-1 overflow-hidden rounded-lg border bg-card lg:grid-cols-[280px_minmax(0,1fr)_300px]">
